...
const navigation = [
  ...
  { name: "Technical Reports", href: "/dashboard/technical-reports", icon: FileText },
  { name: "Technical Report List", href: "/dashboard/technical-reports/list", icon: FileText },
    ...
    <AdminRoleGuard>
      ...
      >
        <div className="flex h-full flex-col" suppressHydrationWarning>
          ...
          {/* Navigation — scroll when items exceed viewport (scrollbar hidden) */}
          <nav className="min-h-0 flex-1 space-y-1 overflow-y-auto overscroll-contain px-2 py-4 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            {navigation.map((item) => {
